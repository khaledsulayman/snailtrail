...
set title "Differential PAG latency CDF [150K]\n{/*0.8 y% of epochs take less than x s}"
...
set title "Differential PAG latency CDF [250K]\n{/*0.8 y% of epochs take less than x s}"
...
set title "Differential PAG latency CDF [500K]\n{/*0.8 y% of epochs take less than x s}"
...
set title "Differential PAG latency CDF [1M]\n{/*0.8 y% of epochs take less than x s}"
