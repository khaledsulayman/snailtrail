...
set title "Differential PAG throughput CDF [250K]\n{/*0.8 y% of epochs process less than x log events / s}"
...
set title "Differential PAG throughput CDF [500K]\n{/*0.8 y% of epochs process less than x log events / s}"
...
set title "Differential PAG throughput CDF [1M]\n{/*0.8 y% of epochs process less than x log events / s}"
