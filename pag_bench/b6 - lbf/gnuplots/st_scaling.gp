...
plot \
  "prepped/prepped_scaling_1.csv" using 1:2 with lines smooth bezier ls 1 title "w1", \
  "prepped/prepped_scaling_2.csv" using 1:2 with lines smooth bezier ls 3 title "w2", \
  "prepped/prepped_scaling_4.csv" using 1:2 with lines smooth bezier ls 5 title "w4", \
  "prepped/prepped_scaling_8.csv" using 1:2 with lines smooth bezier ls 7 title "w8", \
  "prepped/prepped_scaling_16.csv" using 1:2 with lines smooth bezier ls 9 title "w16", \
  "prepped/prepped_scaling_32.csv" using 1:2 with lines smooth bezier ls 11 title "w32"
...
plot \
  "prepped/prepped_scaling_1.csv" using 1:3 with lines smooth bezier ls 1 title "w1", \
  "prepped/prepped_scaling_2.csv" using 1:3 with lines smooth bezier ls 3 title "w2", \
  "prepped/prepped_scaling_4.csv" using 1:3 with lines smooth bezier ls 5 title "w4", \
  "prepped/prepped_scaling_8.csv" using 1:3 with lines smooth bezier ls 7 title "w8", \
  "prepped/prepped_scaling_16.csv" using 1:3 with lines smooth bezier ls 9 title "w16", \
  "prepped/prepped_scaling_32.csv" using 1:3 with lines smooth bezier ls 11 title "w32"
