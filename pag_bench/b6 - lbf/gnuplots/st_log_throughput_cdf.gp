...
plot \
  ...
  input("prepped/prepped_st_16_50.csv", "prepped/prepped_tc_32_50.csv") using 1:($3 / stat16_max) with lines ls 9 title "w8x2", \
  baseline("prepped/prepped_tc_32_50.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri8"
